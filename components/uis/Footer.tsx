...
import { BasicFooter } from '@/components/uis/bfooter';
import { Logo } from '@/components/uis/mylogo';
import { socialMediaProfiles } from '@/components/uis/SocialMedia';
        ...
        <Container as="footer" className="mt-24 w-full sm:mt-32 lg:mt-40">
            <FadeIn>
                ...
                <div className="mb-20 mt-24 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
                    ...
                    <p className="text-sm text-[#7C5338]">
                        © By ME, Jesus. {new Date().getFullYear()}
                    </p>
                </div>
            </FadeIn>
        </Container>
